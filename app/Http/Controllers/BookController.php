...
class BookController extends Controller
{
    ...
    public function show(Request $request, $id)
    {
        ...
        $count = DB::select('SELECT classes.cl_name,COUNT(classes.cl_id) AS soLuong from booksubscription
         JOIN students on booksubscription.stu_id = students.stu_id 
         JOIN classes ON classes.cl_id = students.cl_id 
         WHERE booksubscription.bookid = :idBook  AND booksubscription.status = 0 
         GROUP BY (classes.cl_name)', ['idBook' => $id]);
