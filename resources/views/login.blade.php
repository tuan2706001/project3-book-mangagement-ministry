                                ...
                                <div class="card" data-background="color" data-color="blue">
                                    ...
                                    <div class="card-content">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="mi_userName" placeholder="Nhập email" 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="mi_passWord" placeholder="Nhập mật khẩu" class="form-control input-no-border">
                                        </div>
                                    </div>
